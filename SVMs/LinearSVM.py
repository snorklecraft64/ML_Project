...
if sys.argv[1] == '1' or sys.argv[1] == '3':
  model = LinearSVC(loss='hinge', random_state=1, C=0.01) #best model chosen by below cross validation
else:
  model = LinearSVC(loss='squared_hinge', random_state=1, C=0.01) #best model chosen by below cross validation
model.fit(X,y)
...
#use hinge loss
if sys.argv[1] == '1' or sys.argv[1] == '3':
  model = LinearSVC(loss='hinge', random_state=1)
#use squared hinge loss
else:
  model = LinearSVC(loss='squared_hinge', random_state=1)
